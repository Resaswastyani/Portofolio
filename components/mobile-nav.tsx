      ...
      <div className="pointer-events-auto w-full max-w-3xl">
        ...
        >
          ...
          <div className="flex items-center gap-2">
            <ThemeToggle />
            <a href="mailto:resaarrazy@gmail.com" className="text-[11px] px-4 py-2 rounded-xl border border-black/10 dark:border-white/10 text-black/60 dark:text-white/60 hover:text-black dark:hover:text-white hover:border-black/20 dark:hover:border-white/20 hover:bg-black/[0.03] dark:hover:bg-white/[0.05] transition-all duration-200 tracking-wide hidden md:block" style={{ fontFamily: "system-ui, -apple-system, sans-serif" }}>
              HIRE ME
            </a>
        ...
        >
          ...
          >
            ...
            <div className="mt-1 px-2 pb-1">
              <a href="mailto:resaarrazy@gmail.com" className="block w-full text-center text-[11px] px-4 py-2.5 rounded-xl border border-black/10 dark:border-white/10 text-black/60 dark:text-white/60 hover:text-black dark:hover:text-white hover:border-black/20 dark:hover:border-white/20 hover:bg-black/[0.03] dark:hover:bg-white/[0.05] transition-all duration-200 tracking-wide" style={{ fontFamily: "system-ui, -apple-system, sans-serif" }}>
                HIRE ME
              </a>
            </div>
          </div>
